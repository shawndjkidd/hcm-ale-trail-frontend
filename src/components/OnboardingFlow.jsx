...
const STEPS = [
  {
    ...
    multi: false,
    options: [
      { id: "chill", label: "Chill Vibes", icon: "😎", desc: "Low-key spots, cold beers" },
      { id: "explorer", label: "Bar Hopper", icon: "🗺️", desc: "Hit every spot on the map" },
      { id: "social", label: "Here for the Party", icon: "🥳", desc: "Where the people at?" },
      { id: "craftnerd", label: "Beer Snob", icon: "🧐", desc: "ABV, IBU, all of it" },
    ],
  },
  {
    key: "beerStyles",
    ...
    multi: true,
    options: [
      { id: "ipa", label: "IPA", icon: "🔥", desc: "Hops on hops" },
      { id: "lager", label: "Lager", icon: "💛", desc: "Keep it classic" },
      { id: "stout", label: "Stout", icon: "🌑", desc: "Dark side energy" },
      { id: "sour", label: "Sour", icon: "😝", desc: "Pucker up" },
      { id: "wheat", label: "Wheat", icon: "☀️", desc: "Easy breezy" },
      { id: "surprise", label: "Surprise me!", icon: "🎰", desc: "Feeling lucky" },
    ],
  },
  {
    key: "groupSize",
    ...
    multi: false,
    options: [
      { id: "solo", label: "Lone Wolf", icon: "🐺", desc: "Just me & a cold one" },
      { id: "duo", label: "Dynamic Duo", icon: "🤝", desc: "Partner in crime" },
      { id: "crew", label: "The Squad", icon: "💪", desc: "3\u20135 deep" },
      { id: "party", label: "Full Send", icon: "🚀", desc: "The more the merrier" },
    ],
  },
  {
    key: "era",
    ...
    multi: false,
    options: [
      { id: "rookie", label: "Fresh ID", icon: "🎓", desc: "18\u201324 \u00B7 Just getting started" },
      { id: "prime", label: "In My Prime", icon: "⚡", desc: "25\u201334 \u00B7 Peak form" },
      { id: "seasoned", label: "Seasoned", icon: "🥃", desc: "35\u201344 \u00B7 I know what I like" },
      { id: "og", label: "OG", icon: "👑", desc: "45+ \u00B7 Been here since day one" },
    ],
  },
  {
    key: "avatar",
    ...
    multi: false,
    options: [
      { id: "dude", label: "The Dude", icon: "🍻", desc: "Classic legend" },
      { id: "lady", label: "The Lady", icon: "💃", desc: "Runs this town" },
      { id: "mystery", label: "Mystery", icon: "🕶️", desc: "Wouldn't you like to know" },
    ],
  },
  {
    key: "about",
...
const NEIGHBORHOODS = [
  { id: "d1", label: "District 1", icon: "🏙️" },
  { id: "d2", label: "D2 / Thu Duc", icon: "🌴" },
  { id: "d3", label: "District 3", icon: "🛵" },
  { id: "d7", label: "District 7", icon: "🌆" },
  { id: "other_vn", label: "Other Vietnam", icon: "🇻🇳" },
  { id: "visitor", label: "Just Visiting!", icon: "🧳" },
];
    ...
    <div className="onboarding-overlay">
      <div className="onboarding-modal">
        ...
        {current.isTextStep ? (
              ...
              <div className="onboarding-tiles onboarding-tiles-3col">
                {NEIGHBORHOODS.map((opt) => (
                  ...
                  >
                    ...
                    {answers.neighborhood === opt.id && <span className="onboarding-tile-check">✓</span>}
                  </button>
                ))}
              </div>
            </div>
          ...
          <div className={`onboarding-tiles ${current.options.length > 4 ? "onboarding-tiles-3col" : ""}`}>
            {current.options.map((opt) => (
              ...
              >
                ...
                {isSelected(opt.id) && <span className="onboarding-tile-check">✓</span>}
              </button>
            ))}
          </div>
        )}
        ...
        <div className="onboarding-nav">
          ...
          >
            {saving ? "Saving..." : step === totalSteps - 1 ? "LET'S GO! 🍺" : "NEXT"}
          </button>
        </div>
      </div>
    </div>
