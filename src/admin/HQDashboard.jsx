                  ...
                  <div key={item.id} className="admin-card" style={{ marginBottom: 12, background: 'var(--admin-bg-tertiary)' }}>
                    ...
                    <div style={{ display: 'flex', gap: 24, marginTop: 12, flexWrap: 'wrap' }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: 24, fontWeight: 700, color: item.lowStockBreweries?.length > 0 ? 'var(--admin-danger)' : 'inherit' }}>
                            ...
                            {Object.entries(item.byBrewery).map(([bId, info]) => {
                              ...
                              return (
                                <tr key={bId}>
                                  ...
                                  <td style={{ color: isLow ? 'var(--admin-danger)' : 'inherit', fontWeight: isLow ? 700 : 400 }}>
                                    {info.stock}{isLow ? ' ⚠️' : ''}
                                  </td>
                                  <td>{info.pickups}</td>
                                  <td>
