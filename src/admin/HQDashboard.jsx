          ...
          {showBreweryForm && (
            <div className="admin-modal-overlay" onClick={() => setShowBreweryForm(false)}>
              <div className="admin-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="admin-form-group"><label className="admin-form-label">Name *</label><input type="text" className="admin-form-input" value={breweryForm.name} onChange={(e) => setBreweryForm({...breweryForm, name: e.target.value})} placeholder="Brewery Name" /></div>
                <div className="admin-form-group"><label className="admin-form-label">Address</label><input type="text" className="admin-form-input" value={breweryForm.address} onChange={(e) => setBreweryForm({...breweryForm, address: e.target.value})} placeholder="123 Beer Street" /></div>
          ...
          {showQuestForm && (
            <div className="admin-modal-overlay" onClick={() => setShowQuestForm(false)}>
              <div className="admin-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="admin-form-group"><label className="admin-form-label">Title (English) *</label><input type="text" className="admin-form-input" value={questForm.titleEn} onChange={(e) => setQuestForm({...questForm, titleEn: e.target.value})} placeholder="Visit all 8 breweries in one day" /></div>
                <div className="admin-form-group"><label className="admin-form-label">Title (Vietnamese)</label><input type="text" className="admin-form-input" value={questForm.titleVn} onChange={(e) => setQuestForm({...questForm, titleVn: e.target.value})} /></div>
